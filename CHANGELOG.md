...
Note that `ckeditor4-vue` package already exposes two variants of the library (es6-compatible and a legacy one). The polyfill will still be used to support the legacy version.
